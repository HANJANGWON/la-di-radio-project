      ...
      style={{
        ...
        border:
          variant === 'ghost'
            ? 'none'
            : variant === 'primary'
              ? `0.666667px solid ${theme.colors.semantic.border}`
              : `1px solid ${theme.colors.semantic.border}`,
        cursor: 'pointer',
        display: 'inline-flex',
        alignItems: 'center',
        ...
        borderRadius:
          variant === 'primary'
            ? theme.spacing.borderRadius.rounded
            : variant === 'secondary'
              ? theme.spacing.borderRadius.pill
              : theme.spacing.borderRadius.large,
        ...
        fontSize:
          size === 'small'
            ...
            : size === 'medium'
              ? theme.typography.fontSizes.regular
              : theme.typography.fontSizes.large,
